...
Este projeto tem como objetivo a segmentação de uma base de clientes utilizando a metodologia RFM e o algoritmo de clusterização K-Means. A análise transforma dados brutos de vendas em perfis estratégicos, facilitando a personalização de campanhas de marketing e o aumento da retenção de consumidores.

### Tecnologias Utilizadas

* Python (Pandas e NumPy)
* Scikit-learn (K-Means e StandardScaler)
* Matplotlib e Plotly

### Metodologia de Análise

Para garantir a consistência estatística dos grupos, o pipeline de dados foi estruturado da seguinte forma:
